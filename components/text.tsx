    ...
    <div>
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 text-white w-full overflow-y-auto bg-indigo-950 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <Link
                    href="https://fendous.dk/portal/log-in.html?cbr=dbafb0001d051a03c77e42e8b03f"
